 ...
 * Initializes when the sky map section enters the viewport to avoid blocking first paint.
 */
(function () {
  "use strict";
  ...
  var section = container.closest(".M-SkyMap-Section");
  var started = false;
  ...
  function initSkyMap() {
    ...
    function draw() {
      if (!viewReady || !catalog.length) return;
      var rect = viewport.getBoundingClientRect();
    ...
    function showPopup(obj) {
      ...
      popup.innerHTML =
        ...
        '" alt="M' +
        obj.num +
        '" class="M-SkyMap-Popup-Img" loading="lazy" decoding="async" />' +
    ...
    if (bgImg.dataset.src && !bgImg.getAttribute("src")) {
      bgImg.setAttribute("src", bgImg.dataset.src);
    }
